...
# length of nums2.
# We traverse nums2 once to build the next_greater dictionary and then
# traverse nums1 to construct the result.
# Space Complexity: O(M), the space used by the next_greater dictionary
# and the stack in the worst case is proportional to the size of nums2.
